            ...
            <nav className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='flex items-center justify-between h-16'>
                    ...
                    <div className='flex items-center gap-1'>
                        <form onSubmit={handleSearch} className='hidden lg:flex items-center bg-neutral-50 border border-neutral-200 rounded-full px-3.5 py-2 w-52 focus-within:bg-white focus-within:border-neutral-300 transition-all'>
                            ...
                            <input type='text' placeholder='Search...' value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className='w-full pl-2 text-sm bg-transparent border-0 border-transparent focus:border-transparent focus:ring-0 outline-none focus:outline-none placeholder-neutral-400 no-global-focus' />
                        </form>
                ...
                {isMenuOpen && (
                    <div className='md:hidden border-t border-neutral-100 py-4 space-y-1 animate-fade-in'>
                        ...
                        <form onSubmit={handleSearch} className='flex items-center bg-neutral-50 border border-neutral-300 rounded-full px-3.5 py-2 w-full focus-within:bg-white focus-within:border-neutral-300 transition-all mx-3 mb-2 mt-2' style={{ width: 'calc(100% - 24px)' }}>
                            <Search className='w-4 h-4 text-neutral-400' />
                            <input type='text' placeholder='Search...' value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className='w-full pl-2 text-sm bg-transparent focus:ring-0 outline-none focus:outline-none placeholder-neutral-400 no-global-focus'/>
                        </form>
