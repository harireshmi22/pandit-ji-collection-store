...
const NavBar = ({ onMenuClick }) => {
    ...
    return (
        <div className="bg-white/88 backdrop-blur-md border-b border-blue-200/70 px-4 sm:px-6 py-3 flex justify-between items-center sticky top-0 z-30">
            ...
            <div className="flex items-center gap-2">
                <button className="p-2 hover:bg-blue-50 rounded-xl transition-colors relative">
                ...
                <div className="flex items-center gap-2.5 pl-1">
                    ...
                    <div className="w-9 h-9 rounded-xl bg-linear-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white ring-2 ring-blue-100">
                        {session?.user?.name ? (
