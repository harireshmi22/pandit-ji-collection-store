        ...
        <div className='min-h-screen bg-white'>
            ...
            <div className='bg-neutral-900 text-white py-20 md:py-28'>
                <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
                    <p className='text-xs uppercase tracking-widest text-neutral-400 mb-4'>About Us</p>
            ...
            <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
                    <div>
                        <p className='text-xs uppercase tracking-widest text-neutral-400 mb-3'>Our Story</p>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        {[
                            ...
                            <div key={stat.label} className='border border-neutral-100 rounded-2xl p-5 text-center'>
            ...
            <div className='bg-neutral-50 py-16 md:py-24'>
                <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-12'>
                        <p className='text-xs uppercase tracking-widest text-neutral-400 mb-3'>What We Stand For</p>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                        {[
                            ...
                            <div key={v.title} className='bg-white border border-neutral-100 rounded-2xl p-6'>
                                <div className='w-10 h-10 bg-neutral-50 rounded-xl flex items-center justify-center mb-4'>
                                    <v.icon className='w-5 h-5 text-neutral-700' />
                                </div>
            ...
            <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center'>
                ...
                <Link href='/shop' className='inline-flex items-center gap-2 bg-neutral-900 text-white px-8 py-3 rounded-full text-sm font-medium hover:bg-neutral-800 transition-colors'>
                    Shop Now
                </Link>
            </div>
